...
import com.example.axon.axondemo.event.AccountActivatedEvent;
import com.example.axon.axondemo.event.AccountCreatedEvent;
import com.example.axon.axondemo.event.AccountHeldEvent;
import com.example.axon.axondemo.event.MoneyCreditedEvent;
import com.example.axon.axondemo.event.MoneyDebitedEvent;
...
public class AccountAggregate {
    ...
    public AccountAggregate(CreateAccountCommand createAccountCommand) {
        AggregateLifecycle.apply(new AccountCreatedEvent(
            createAccountCommand.id, createAccountCommand.accountBalance, createAccountCommand.currency));
    }
    ...
    protected void on(CreditMoneyCommand creditMoneyCommand) {
        AggregateLifecycle.apply(new MoneyCreditedEvent(
            creditMoneyCommand.id, creditMoneyCommand.creditAmount, creditMoneyCommand.currency));
    }
    ...
    protected void on(DebitMoneyCommand debitMoneyCommand) {
        AggregateLifecycle.apply(new MoneyDebitedEvent(
            debitMoneyCommand.id, debitMoneyCommand.debitAmount, debitMoneyCommand.currency));
    }
